...
public class ShopUIScript : MonoBehaviour
{
    ...
    private int diamondPriceForGold = 5; //골드당 다이아몬드 가격. 추후 리스트로 바꿔서 각기 정해줄 예정
    ...
    private void Update()
    {
        if (playerMoneyCount == NONE || playerDiamondCount == NONE)
        {
    ...
    private void SetShopUIPanel()
    {
        ...
        currentPlayerMoneyText = GameObject.Find("CurrentPlayerCashText").GetComponent<Text>();
